package top.b0x0.rpc.socket.aserver;

import top.b0x0.rpc.socket.aserver.rpcclient.RpcClientInvocationHandler;
...
public class TestOneRpc {
    ...
    static {
        try {
            //在加载当前类的时候将RPC框架服务启动
            Class.forName("top.b0x0.rpc.socket.aserver.rpcclient.RpcClientStart", true, Thread.currentThread().getContextClassLoader());
